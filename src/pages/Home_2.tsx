  ...
  return (
    <div className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <section className="relative h-screen">
        ...
        {/* Glow */}
        <div className="absolute top-0 left-0 h-[500px] w-[500px] rounded-full bg-[#F5C518]/10 blur-3xl" />

        {/* Content */}
        <div className="relative z-10 flex h-full items-end px-8 pb-24 md:px-16">
          <div className="max-w-3xl">
            <p className="mb-4 text-sm tracking-[0.4em] text-[#F5C518] uppercase">
              Trending Now
            </p>
            ...
            <div className="mt-8 flex items-center gap-4">
              <div className="rounded-full bg-[#F5C518] px-5 py-2 text-sm font-bold text-black">
                ★ {featured.vote_average.toFixed(1)}
              </div>

              <div className="rounded-full border border-white/20 px-5 py-2 text-sm text-gray-300 backdrop-blur-md">
...
function TrendingSection({ movies }: any) {
  return (
    <section className="relative z-20 -mt-20 px-6 pb-20 md:px-12">
      {/* Header */}
      <div className="mb-10 flex items-end justify-between">
        <div>
          <p className="mb-2 text-sm tracking-[0.3em] text-[#F5C518] uppercase">
            Collection
          </p>
        ...
        <div className="hidden h-[2px] w-40 bg-gradient-to-r from-[#F5C518] to-transparent md:block" />
      </div>
...
function TrendingCard({ movie }: any) {
  const navigate = useNavigate();

  return (
    <div
      onClick={() => navigate(`/movie/${movie.id}`)}
      className="group relative min-w-[180px] cursor-pointer overflow-hidden rounded-xl bg-zinc-900 transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_0_40px_rgba(245,197,24,0.18)]"
    >
      {/* Poster */}
      <div className="relative aspect-[2/3] overflow-hidden">
        ...
        {/* Rating */}
        <div className="absolute top-3 right-3 rounded-full bg-black/70 px-2 py-1 text-xs font-bold text-[#F5C518] backdrop-blur-md">
